...
export class CategoryService {
  ...
  getCategory(code: string): Observable<Category> {
    ...
    return this.http.get<Category>(environment.courseListUrl + "/category", { params: params })
  }

  updateCategory(category: Category): Observable<any> {
    return this.http.post<Category>(environment.courseListUrl + "/category", category)
  }
